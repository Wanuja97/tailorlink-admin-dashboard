  ...
  return (
    <div className="flex fixed top-0 left- h-screen w-64 flex-col justify-between border-e bg-cyan-950">
      <div className="px-4 py-6">
        ...
        <nav aria-label="Main Nav" className="mt-6 flex flex-col space-y-1 border-t">
          ...
          <details className="group [&_summary::-webkit-details-marker]:hidden">
            <summary
              className="flex cursor-pointer items-center justify-between rounded-lg px-4 py-2 text-white hover:bg-gray-100 hover:text-black"
            >
      ...
      <div className="sticky inset-x-0 bottom-0 border-t border-gray-100">
        <a href="#" className="flex items-center gap-2 bg-cyan-950 p-4 ">
          <img
            alt="Man"
